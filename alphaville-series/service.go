...
func (ass *AlphavilleSeriesService) Write(thing interface{}, transID string) (interface{}, error) {
	...
	if err = ass.conn.CypherBatch(queryBatch); err != nil {
...
func (ass *AlphavilleSeriesService) Read(uuid string, transID string) (interface{}, bool, error) {
	...
	err := ass.conn.CypherBatch([]*neoism.CypherQuery{query})
	if err != nil {
