...
//		},
//		{
//			testName:             "Creates All Values Present for a Lone LeafConcept",
...
//		},
//		{
//			testName:          "Creates All Values Present for a LeafConcept with a RELATED_TO relationship",
...
//		},
//		{
//			testName:             "Creates All Values Present for a LeafConcept with a RELATED_TO relationship to an unknown thing",
...
//		},
//		{
//			testName:          "Creates All Values Present for a LeafConcept with a HAS_BROADER relationship",
...
//		},
//		{
//			testName:             "Creates All Values Present for a LeafConcept with a HAS_BROADER relationship to an unknown thing",
...
//		},
//		{
//			testName:             "Creates All Values Present for a Concorded LeafConcept",
...
//		},
//		{
//			testName:             "Adding LeafConcept with existing Identifiers fails",
...
//	assert.True(t, found, "LeafConcept should exist")
//	assert.NotNil(t, concept, "LeafConcept should be populated")
...
//	invalidPrefConceptType := `MERGE (t:Thing{prefUUID:"bbc4f575-edb3-4f51-92f0-5ce6c708d1ea"}) SET t={prefUUID:"bbc4f575-edb3-4f51-92f0-5ce6c708d1ea", prefLabel:"The Best Label"} SET t:LeafConcept:Brand:Unknown MERGE (s:Thing{uuid:"bbc4f575-edb3-4f51-92f0-5ce6c708d1ea"}) SET s={uuid:"bbc4f575-edb3-4f51-92f0-5ce6c708d1ea"} SET t:LeafConcept:Brand MERGE (t)<-[:EQUIVALENT_TO]-(s)`
//	invalidSourceConceptType := `MERGE (t:Thing{prefUUID:"4c41f314-4548-4fb6-ac48-4618fcbfa84c"}) SET t={prefUUID:"4c41f314-4548-4fb6-ac48-4618fcbfa84c", prefLabel:"The Best Label"} SET t:LeafConcept:Brand MERGE (s:Thing{uuid:"4c41f314-4548-4fb6-ac48-4618fcbfa84c"}) SET s={uuid:"4c41f314-4548-4fb6-ac48-4618fcbfa84c"} SET t:LeafConcept:Brand:Unknown MERGE (t)<-[:EQUIVALENT_TO]-(s)`
//
//	type testStruct struct {
//		testName         string
//		prefUuid         string
...
//	assert.True(t, found, fmt.Sprintf("Test %s failed: LeafConcept has not been found", testName))
//}
//
//func neoUrl() string {
...
//		Statement: fmt.Sprintf(`
//			match (c:LeafConcept {%s :{uuid}})-[r:IDENTIFIES]-(i:%s) return i.value
...
//	assert.Equal(t, hashAsString, results[0].Hash, fmt.Sprintf("Test %s failed: LeafConcept hash %s and stored record %s are not equal!", testName, hashAsString, results[0].Hash))
//}
