...
type MembershipRoleService struct {
	conn neoutils.NeoConnection
}

func NewMembershipRoleService(db neoutils.NeoConnection) *MembershipRoleService {
	return &MembershipRoleService{db}
}

func (mrs *MembershipRoleService) Write(thing interface{}, transID string) (interface{}, error) {
	...
	if err = mrs.conn.CypherBatch(queryBatch); err != nil {
...
func (mrs *MembershipRoleService) Read(uuid string, transID string) (interface{}, bool, error) {
	...
	err := mrs.conn.CypherBatch([]*neoism.CypherQuery{query})
	if err != nil {
