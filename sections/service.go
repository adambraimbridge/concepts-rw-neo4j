...
func NewSectionService(db neoutils.NeoConnection) *SectionService {
	return &SectionService{db}
}

func (ss *SectionService) Write(thing interface{}, transID string) (interface{}, error) {
...
func (ss *SectionService) Read(uuid string, transID string) (interface{}, bool, error) {
