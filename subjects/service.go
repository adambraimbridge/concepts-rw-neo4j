...
func NewSubjectService(db neoutils.NeoConnection) *SubjectService {
	return &SubjectService{db}
}

func (ss *SubjectService) Write(thing interface{}, transID string) (interface{}, error) {
	...
	if err = ss.conn.CypherBatch(queryBatch); err != nil {
...
func (ss *SubjectService) Read(uuid string, transID string) (interface{}, bool, error) {
	...
	err := ss.conn.CypherBatch([]*neoism.CypherQuery{query})
	if err != nil {
